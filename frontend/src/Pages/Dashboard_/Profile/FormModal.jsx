...
const FormModal = ({ isOpen, onClose, modalType, editData, isEditing, onSave, currentDate }) => {
    ...
    switch (type) {
      case 'Education':
        return {
          ...
          endYear: (parseInt(currentYear) + 4).toString()
        };
      case 'Projects':
        return {
          title: '',
  ...
  const validateForm = () => {
    ...
    switch (modalType) {
      ...
      case 'Social Links':
        ...
        ['portfolio', 'twitter', 'devfolio', 'unstop', 'github'].forEach(field => {
      ...
      case 'Hackathon Preferences':
        if (selectedRoles.length === 0) {
          newErrors.rolePreferences = 'Please select at least one role preference';
        }
        
        const selectedDomains = Object.keys(domainChecks).filter(key => domainChecks[key]);
        if (selectedDomains.length === 0) {
          newErrors.domainInterests = 'Please select at least one domain interest';
        }
        break;
      ...
      case 'Tagline':
        return (
            <div>
            <label className="block text-[#11014c] mb-2">Your Professional Tagline</label>
            <textarea 
                value={formData || ''}
            ...
            <p className="text-sm text-[#11014c] mt-2">
                A brief statement that summarizes your professional identity, expertise, or career focus.
                It's like a headline on your professional profile.
            </p>
            </div>
        );
  ...
  const handleSubmit = () => {
    ...
    if (modalType === 'Education') {
      ...
      dataToSave = {
        ...
        domainInterests: Object.keys(domainChecks).filter(key => domainChecks[key])
      };
    }
    ...
    switch (modalType) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-[#11014c] mb-2">
                  {educationType === 'College' ? 'University Name' : 'School Name'} <span className="text-red-600">*</span>
                </label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="block text-[#11014c] mb-2">Degree <span className="text-red-600">*</span></label>
                <select 
                  name="degree"
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              <label className="block text-[#11014c] mb-2">Project Title <span className="text-red-600">*</span></label>
              <input 
                type="text" 
                name="title"
      ...
      case 'Work Experience':
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              <label className="block text-[#11014c] mb-2">Company Name <span className="text-red-600">*</span></label>
              <input 
                type="text" 
                name="company"
            ...
            <div>
              <label className="block text-[#11014c] mb-2">Position <span className="text-red-600">*</span></label>
              <input 
                type="text" 
                name="position"
      ...
      case 'Position of Responsibility':
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              <label className="block text-[#11014c] mb-2">Title/Position <span className="text-red-600">*</span></label>
              <input 
                type="text" 
                name="title"
                value={formData.title || ''}
            ...
            <div className="md:col-span-2">
              <label className="block text-[#11014c] mb-2">Organization <span className="text-red-600">*</span></label>
              <input 
                type="text" 
                name="organization"
      ...
      case 'Achievements':
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              <label className="block text-[#11014c] mb-2">Achievement Title <span className="text-red-600">*</span></label>
              <input 
                type="text" 
                name="title"
                value={formData.title || ''}
            ...
            <div className="md:col-span-2">
              <label className="block text-[#11014c] mb-2">Issuing Organization <span className="text-red-600">*</span></label>
              <input 
                type="text" 
                name="issuer"
      ...
      case 'Certifications':
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              <label className="block text-[#11014c] mb-2">Certification Name <span className="text-red-600">*</span></label>
              <input 
                type="text" 
                name="title"
                value={formData.title || ''}
        ...
        return (
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="mt-3 text-sm text-[#11014c]">
              <p><span className="text-red-600">*</span> LinkedIn URL is required. Other fields are optional.</p>
              <p className="mt-1">Tip: If you don't have accounts on all platforms, just fill in the ones you use.</p>
            </div>
          </div>
        );
      ...
      case 'Hackathon Preferences':
        return (
          <div className="space-y-8">
            {/* Role Preferences */}
            <div>
              <h3 className="font-bold text-[#340062] mb-4">Role Preferences <span className="text-red-600">*</span></h3>
              <p className="text-sm text-[#11014c] mb-3">
                Select up to 3 roles in order of your preference. Drag to reorder.
              </p>
              <div className={`space-y-2 p-4 rounded-lg border ${errors.rolePreferences ? 'border-red-500' : 'border-[#b6cbff]'}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {['Frontend Developer', 'Backend Developer', 'Full Stack Developer', 'UI/UX Designer', 
                    ...
                    'Product Manager', 'QA Engineer'].map((role) => (
                    <div 
                      key={role}
                ...
                {selectedRoles.length > 0 && (
                  <div className="mt-4 p-3 bg-[#f6ebff] rounded-lg">
                    <p className="font-medium text-[#340062]">Your preferences:</p>
                    <ol className="mt-2 pl-5 list-decimal">
                      {selectedRoles.map((role, index) => (
                        <li key={index} className="text-[#11014c]">{role}</li>
                      ))}
                    </ol>
                  </div>
                )}
                ...
                {errors.rolePreferences && (
                  <p className="text-red-500 text-xs mt-2">{errors.rolePreferences}</p>
                )}
              </div>
            </div>
            ...
            {/* Domain Interests */}
            <div>
              <h3 className="font-bold text-[#340062] mb-4">Domain Interests <span className="text-red-600">*</span></h3>
              <p className="text-sm text-[#11014c] mb-3">
                Select all domains you're interested in working on during hackathons.
              </p>
              <div className={`p-4 rounded-lg border ${errors.domainInterests ? 'border-red-500' : 'border-[#b6cbff]'}`}>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {['AI/ML', 'Web Development', 'Mobile Apps', 'Blockchain', 
                    'AR/VR', 'IoT', 'Cybersecurity', 'FinTech', 'HealthTech', 
                    'EdTech', 'Gaming', 'Social Impact', 'Sustainability', 
                    'DevOps', 'Cloud Computing', 'Data Science'].map((domain) => (
                    <div 
                      key={domain} 
                ...
                {errors.domainInterests && (
                  <p className="text-red-500 text-xs mt-2">{errors.domainInterests}</p>
                )}
              </div>
            </div>
            ...
            {/* Experience Level */}
            <div>
              <h3 className="font-bold text-[#340062] mb-4">Hackathon Experience</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-[#11014c] mb-2">Experience Level</label>
                  <select 
                  ...
                  >
                    ...
                    <option value="Intermediate">Intermediate (2-5 hackathons)</option>
                ...
                <div>
                  <label className="block text-[#11014c] mb-2">Hackathons Participated</label>
                  <input 
                    type="number" 
            ...
            <div>
              <h3 className="font-bold text-[#340062] mb-4">Collaboration Preferences</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-[#11014c] mb-2">Preferred Team Size</label>
                  <select 
                    name="teamSize"
                ...
                <div>
                  <label className="block text-[#11014c] mb-2">Communication Preference</label>
                  <select 
                ...
                <div>
                  <label className="block text-[#11014c] mb-2">Work Style</label>
                  <select 
                    name="workStyle"
                  ...
                  >
                    ...
                    <option value="Independent">Independent (divide and conquer)</option>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-[#11014c] mb-2">Typical Availability</label>
                  <select 
                    name="availability"
                ...
                <div>
                  ...
                  <input 
                    type="text" 
                    name="timezone"
                    value={formData.timezone || 'GMT+0530 (India Standard Time)'}
                    onChange={handleInputChange}
                    placeholder="e.g., GMT+0530 (IST)" 
                    className="w-full px-3 py-2 border border-[#b6cbff] rounded focus:outline-none focus:ring-1 focus:ring-[#340062]"
                  />
                </div>
                
                <div>
                  <label className="block text-[#11014c] mb-2">Weekly Commitment</label>
                  <select 
            ...
            <div className="mt-4 p-4 bg-[#f6ebff] rounded-lg">
              <p className="text-[#340062] font-medium">
                ...
                These preferences help our AI to better match you with team members and projects 
                that align with your interests and working style.
              </p>
            </div>
          </div>
        );
