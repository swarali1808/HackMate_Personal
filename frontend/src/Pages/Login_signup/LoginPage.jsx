  ...
  return (
    <div className="flex flex-col lg:flex-row w-full min-h-screen font-poppins">
      ...
      <div 
        ...
        style={{
          background: "radial-gradient(circle at center, #000000 30%, #340776 210%)"
        }}
      >
        <motion.div 
        ...
        >
          <div className="mb-10">
            <h2 className="text-4xl font-outfit font-bold mb-3 text-white tracking-tight">Welcome back</h2>
          ...
          <form className="space-y-5">
            ...
            >
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember" className="ml-2 text-sm text-gray-400 font-poppins">
                  Remember me
                </label>
              </div>
            ...
            >
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.97 }}
              >
                <img src="/api/placeholder/20/20" alt="Github" className="w-5 h-5 mr-2" />
                Github
              </motion.button>
            </motion.div>
          </form>
      ...
      <div className="w-full lg:w-3/5 flex flex-col items-start justify-center p-6 relative overflow-hidden min-h-screen lg:min-h-full">
        ...
        <div className="absolute top-6 left-6 z-10">
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <Link to="/" className="flex items-center text-light-primary bg-dark-secondary1 bg-opacity-80 px-3 py-1.5 rounded-full text-xs">
          ...
          >
            {[
              { 
                ...
                description: "Track tasks and team progress in real-time—smooth execution guaranteed.",
                icon: "🔍"
              },
              { 
                title: "Secure Storage", 
                description: "Store project data with maximum protection, all in one place.",
                icon: "🔐" 
              },
              { 
                title: "Team Collaboration", 
                description: "Smart matchmaking and skill-based task allocation for seamless teamwork.",
                icon: "👥" 
              },
              { 
                title: "24/7 AI Assistant", 
                description: "Get instant help for tasks, tool suggestions, and team well-being tips.",
                icon: "🆘" 
              }
            ].map((feature, index) => (
              <motion.div
              ...
              >
                ...
                <h3 className="text-sm font-semibold mb-0.5 text-light-primary">{feature.title}</h3>
                <p className="text-xs text-light-primary text-opacity-80">{feature.description}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
